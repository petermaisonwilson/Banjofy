...
APP_VERSION = "Banjofy 006.3.0 Module 17 Build 003 - Segment-Aligned Chords"
...
class MainWindow(LegacyMainWindow):
    ...
    def __init__(self) -> None:
        ...
        self.statusBar().showMessage("Ready - Module 17 real chord analysis loaded")

    def _set_visible_titles(self) -> None:
        for label in self.findChildren(QLabel):
            if label.objectName() == "Title":
                if "Practice" in label.text():
                    label.setText("Practice Studio - Module 17 Build 003")
                else:
