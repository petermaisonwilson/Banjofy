...
APP_TITLE = "Banjofy Song Analysis Engine — Chord Laboratory 016 Baseline"
MODEL_NAME = "ChordMini ChordNet + confidence-gated independent chroma detector"
ANALYSIS_VERSION = 16
...
def analyse_audio(
    ...
    diagnostics = [
        ...
        "This laboratory remains separate from Module 16 Solid.",
    ]
